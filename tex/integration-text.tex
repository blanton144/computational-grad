...
yields an approximation $\hat I_1$ that differs from the real integral
$I$ as follows:
\begin{equation}
\hat I_1 = I + \epsilon \Delta x^2 + \mathcal{O}\left(\Delta x^4\right)
\end{equation}
...
\begin{equation}
\hat I_2 = I + \frac{1}{4} \epsilon \Delta x^2 + \mathcal{O}\left(\Delta x^4\right)
\end{equation}
Having done this we can combine these results and cancel the leading error
term:
\begin{equation}
\hat I = \frac{4}{3} I_2 - \frac{1}{3} I_1 = I + \mathcal{O}\left(\Delta x^4\right)
\end{equation}
...
estimate:
\begin{equation}
\epsilon \Delta x^2 = \frac{4}{3}  \left(\hat I_2 - \hat I_1\right)
\end{equation}
...
Simpson's method can be extended, through something called Richardson
extrapolation. The idea is 
